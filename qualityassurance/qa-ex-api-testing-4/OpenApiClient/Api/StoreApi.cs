...
namespace Applications.PetStore.Swagger.Api
{
        ...
        public partial class StoreApi : IStoreApi
    {
        ...
        {
            this.Configuration = new Applications.PetStore.Swagger.Client.Configuration { BasePath = basePath };
        ...
        public StoreApi()
        {
            this.Configuration = Applications.PetStore.Swagger.Client.Configuration.Default;
        ...
        /// <returns></returns>
        public StoreApi(Applications.PetStore.Swagger.Client.Configuration configuration = null)
        {
        ...
        public Applications.PetStore.Swagger.Client.Configuration Configuration {get; set;}
